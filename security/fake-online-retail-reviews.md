...
How to think about this ^.  Expensive items will not sell in large quantities or in large volumes quickly. Cheap items will sell in huge volumes quickly.  If a $2,500 USD watch has 2,500 reviews, and those reviews were all made in 2021, you can say with 100% certainty that it is fake or the reviews are fake - so proceed with caution.Based on the numbers above, you should ask yourself, “Does the total number of reviews match the item?”Example: I just found a product on amazon where the seller is adding fake reviews either themselves, or by paying for bots/click-farms to do them.
